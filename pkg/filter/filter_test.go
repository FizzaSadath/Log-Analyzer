...
func makeMockLogStore() models.LogStore {
	entries := []models.LogEntry{
		{Raw: "entry1", Level: "INFO", Component: "auth", Host: "server1", ReqID: "r1", Time: makeTime("2025-01-01 10:00:00")},
		{Raw: "entry2", Level: "ERROR", Component: "db", Host: "server2", ReqID: "r2", Time: makeTime("2025-01-01 11:00:00")},
		{Raw: "entry3", Level: "INFO", Component: "api", Host: "server1", ReqID: "r3", Time: makeTime("2025-01-01 12:00:00")},
	}
